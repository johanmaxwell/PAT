...
public class AbsensiListPage extends JFrame {
    ...
    private JButton assignLocationButton;
    ...
    public AbsensiListPage(List<LogAbsensi> absensiList, MainLogin mainLoginFrame) {
        ...
        assignLocationButton = new JButton("Assign Location");
        ...
        assignLocationButton.setFont(buttonFont);
        assignLocationButton.setBackground(Color.MAGENTA);
        assignLocationButton.setForeground(buttonFgColor);
        ...
        assignLocationButton.addActionListener(e -> openLocationAssignmentPage());
        ...
        buttonPanel.add(assignLocationButton);
    ...
    private void openLocationAssignmentPage() {
        try {
            ...
            List<String> nipList = (List<String>) response.get("response");

            new LocationAssignmentPage(nipList, this);
            setVisible(false);
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this, "Failed to fetch NIP list: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private static class ImageRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            if (value instanceof ImageIcon) {
                ...
                Image resizedImage = image.getScaledInstance(120, 160, Image.SCALE_SMOOTH);
